...
chrome_version = config.get_setting("chrome_ua_version")
if chrome_version:
    chrome_main_version = chrome_version.split(".")[0]
else:
    chrome_main_version = "114"  # default fallback version

default_headers = {
    "User-Agent": f"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{chrome_main_version}.0.0.0 Safari/537.36",
